...
//  Home screen 
  ...
  displayController.addButton("checkboxes", 2, 50, [](void) {
      displayController.loadScreen("checks");
  });
  displayController.addButton("settings", 65, 50, [](void) {
